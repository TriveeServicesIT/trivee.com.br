<div>
    ...
    @include('livewire.backend.apps.user._subheader-list-default')
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
                            ...
                            <div class="my-lg-0 my-1">
                                <a href="#"
                                    class="btn btn-sm btn-light-primary font-weight-bolder text-uppercase mr-2">Editar</a>
                                <button href="#" onclick="confirmDelete({{ $user->id }})"
                                    class="btn btn-sm btn-danger font-weight-bolder text-uppercase">Excluir</button>
                            </div>
                            <!--end::Actions-->
                        </div>
                        <!--end::Title-->
    ...
    {{-- $users->links() --}}
    {{ $users->links('layout.base._custom-pagination-links-view') }}
