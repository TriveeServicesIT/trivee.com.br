...
<div class="login-signup">
  <div class="mb-20">
    <h2>Nova conta</h2>
    <h4 class="opacity-60">Insira seus dados para criar sua conta</h4>
  </div>
  <form class="text-center form" id="kt_login_signup_form" method="POST" action="/register">
    ...
    <div class="form-group">
      <input
        ...
        type="text" id="name" placeholder="Nome completo" name="name" :value="old('name')" required autofocus/>
    </div>
    <div class="form-group">
      <input
        class="h-auto px-8 py-4 text-white placeholder-white border-0 form-control opacity-70 bg-dark-o-70 rounded-pill"
        type="email" id="email" placeholder="E-mail" name="email" :value="old('email')" autocomplete="off" required/>
    </div>
    <div class="form-group">
      <input
        class="h-auto px-8 py-4 text-white placeholder-white border-0 form-control opacity-70 bg-dark-o-70 rounded-pill"
        type="password" id="password" placeholder="Senha" name="password" required autocomplete="new-password"/>
    </div>
    <div class="form-group">
      <input
        class="h-auto px-8 py-4 mb-3 text-white placeholder-white border-0 form-control opacity-70 bg-dark-o-70 rounded-pill"
        type="password" id="password_confirmation" placeholder="Confirmar senha" name="password_confirmation" />
    ...
    <div class="form-group">
      <button id="kt_login_signup_submit" type="submit"
        class="py-3 m-2 btn btn-pill btn-outline-white font-weight-bold opacity-90 px-15">Criar conta</button>
      <a id="kt_login_signup_cancel"
        href="/" class="py-3 m-2 btn btn-pill btn-outline-white font-weight-bold opacity-70 px-15">Cancelar</a>
    </div>
  </form>
</div>
